...
# =====================================================================
# NGINX Setup Script (Definitive v2.1 - Complete Edition)
# =====================================================================
...
# Version: 2025-11-06 (System Engineer Review - Complete)
# =====================================================================
...
trap 'handle_error $? "Fatal error occurred at line $LINENO"' ERR
...
main() {
  ...
  if [[ ! -f "$config_file" ]]; then
    ...
    echo "Expected location: $DEFAULT_CONFIG_FILE" >&2
    exit 3
  fi
