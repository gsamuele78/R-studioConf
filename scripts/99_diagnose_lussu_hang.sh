...
echo "  Probe E (PSOCK swap):       $([[ $E_EC -eq 0 ]] && echo PASS || echo FAIL/TIMEOUT)"
echo "  Probe F (terra todisk):     $([[ $F_EC -eq 0 ]] && echo PASS || echo FAIL/TIMEOUT)"
echo
...
# Exit 0 only if generic passed AND both probes passed
