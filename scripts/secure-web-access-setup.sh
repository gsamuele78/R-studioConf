...
# VERSION 12.0: VICTORIOUS. Corrects systemd race condition and template function call.
...
install_services() {
    ...
    # ### DEFINITIVE FIX: Call the function with the correct number of arguments ###
