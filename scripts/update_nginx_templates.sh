...
rstudio_vars_file="${SCRIPT_DIR}/../config/configure_rstudio.vars.conf"
rsession_timeout_minutes=10080 # Default 7 days
...
rsession_timeout_seconds=$(( rsession_timeout_minutes * 60 ))
