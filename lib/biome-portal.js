...
(function (global) {
    ...
    function showProblemReporter() {
        ...
        emailInput.placeholder = 'you@example.com (for follow-up)';
        emailInput.style.width = '100%';
        emailInput.style.padding = '10px';
        emailInput.style.border = '1px solid #ccd1d9';
        emailInput.style.borderRadius = '6px';
        emailInput.style.boxSizing = 'border-box';
        emailInput.style.fontFamily = 'inherit';

        try {
            var savedEmail = localStorage.getItem('biome_report_email');
        ...
        submitBtn.onclick = function () {
            ...
            if (userEmail) {
                try { localStorage.setItem('biome_report_email', userEmail); } catch (e) { }
            }
            ...
            fetch(targetUrl, {
                ...
                if (res.ok) {
                    ...
                    res.text().then(function (t) {
                        ...
                        alert('Error sending report: ' + errMsg);
                    });
                    submitBtn.textContent = 'Send Report';
